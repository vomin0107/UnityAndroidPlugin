...
public class UnityPluginTest : MonoBehaviour
{
    ...
    public bool isPowerSavingMode = false;
    ...
    void Awake()
    {
        ...
        //클래스를 불러와줍니다.
        //패키지명 + 클래스명입니다.
        javaClass = new AndroidJavaClass("com.idealink.toastpowermode.UnityToastPowerMode");
    ...
    public void PowerSaveToast()
    {
        ...
        activityContext.Call("runOnUiThread", new AndroidJavaRunnable(() =>
        {
            javaClassInstance.Call("PowerSavingModeCheck", tmpObj);
        }));
        UnityEngine.Debug.Log("PowerSavingModeCheck");
    }
    ...
    public void AndroidVersionCheck()
    {
        ...
        UnityEngine.Debug.Log("AndroidVersionCheck");
    }
    ...
    // tmpObj[1] = "ModeLog";
    // 요기서 설정한 메소드명입니다.
    public void ModeLog(string isPowerSaveMode)
    {
        if (isPowerSaveMode.Equals("true"))
